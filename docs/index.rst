...
If you ask the mockup to do something that it doesn't understand then we try to fail quickly and fail really hard. Usually with a :exc:`~sgmock.shotgun.ShotgunError` or :exc:`~python:exceptions.NotImplementedError`.
